...
main(int argc, char *argv[])
{
  ...
  34:	8c0a8a93          	add	s5,s5,-1856 # 8f0 <malloc+0xec>
  ...
  6a:	89258593          	add	a1,a1,-1902 # 8f8 <malloc+0xf4>
  6e:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 1be:	892e                	mv	s2,a1
  ...
  fd = open(n, O_RDONLY);
 1c0:	4581                	li	a1,0
 1c2:	18c000ef          	jal	34e <open>
  if(fd < 0)
 1c6:	02054163          	bltz	a0,1e8 <stat+0x36>
 1ca:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 1cc:	85ca                	mv	a1,s2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 406:	50650513          	add	a0,a0,1286 # 908 <digits>
 40a:	883e                	mv	a6,a5
 40c:	2785                	addw	a5,a5,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 496:	e466                	sd	s9,8(sp)
 498:	e06a                	sd	s10,0(sp)
 49a:	1080                	add	s0,sp,96
  char *s;
 ...
 4a0:	26090563          	beqz	s2,70a <vprintf+0x28a>
 4a4:	8b2a                	mv	s6,a0
 4a6:	8a2e                	mv	s4,a1
 4a8:	8bb2                	mv	s7,a2
  state = 0;
 ...
 4bc:	a005                	j	4dc <vprintf+0x5c>
        putc(fd, c0);
 4be:	85ca                	mv	a1,s2
 4c0:	855a                	mv	a0,s6
 4c2:	f05ff0ef          	jal	3c6 <putc>
 4c6:	a019                	j	4cc <vprintf+0x4c>
    } else if(state == '%'){
 4c8:	03598263          	beq	s3,s5,4ec <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
 4cc:	2485                	addw	s1,s1,1
 4ce:	8726                	mv	a4,s1
 4d0:	009a07b3          	add	a5,s4,s1
 4d4:	0007c903          	lbu	s2,0(a5)
 4d8:	22090963          	beqz	s2,70a <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
 4dc:	0009079b          	sext.w	a5,s2
    if(state == 0){
 4e0:	fe0994e3          	bnez	s3,4c8 <vprintf+0x48>
      if(c0 == '%'){
 4e4:	fd579de3          	bne	a5,s5,4be <vprintf+0x3e>
        state = '%';
 4e8:	89be                	mv	s3,a5
 4ea:	b7cd                	j	4cc <vprintf+0x4c>
      if(c0) c1 = fmt[i+1] & 0xff;
 4ec:	cbc9                	beqz	a5,57e <vprintf+0xfe>
 4ee:	00ea06b3          	add	a3,s4,a4
 4f2:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 4f6:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 4f8:	c681                	beqz	a3,500 <vprintf+0x80>
 4fa:	9752                	add	a4,a4,s4
 4fc:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 500:	05878363          	beq	a5,s8,546 <vprintf+0xc6>
      } else if(c0 == 'l' && c1 == 'd'){
 504:	05978d63          	beq	a5,s9,55e <vprintf+0xde>
 ...
 50c:	0ee78763          	beq	a5,a4,5fa <vprintf+0x17a>
 ...
 514:	12e78963          	beq	a5,a4,646 <vprintf+0x1c6>
 ...
 51c:	14e78e63          	beq	a5,a4,678 <vprintf+0x1f8>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 520:	06300713          	li	a4,99
 524:	18e78c63          	beq	a5,a4,6bc <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 528:	07300713          	li	a4,115
 52c:	1ae78263          	beq	a5,a4,6d0 <vprintf+0x250>
 ...
 534:	04e79563          	bne	a5,a4,57e <vprintf+0xfe>
        putc(fd, '%');
 ...
 558:	8bca                	mv	s7,s2
      state = 0;
 55a:	4981                	li	s3,0
 55c:	bf85                	j	4cc <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'd'){
 55e:	06400793          	li	a5,100
 562:	02f68963          	beq	a3,a5,594 <vprintf+0x114>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 566:	06c00793          	li	a5,108
 56a:	04f68263          	beq	a3,a5,5ae <vprintf+0x12e>
      } else if(c0 == 'l' && c1 == 'u'){
 56e:	07500793          	li	a5,117
 572:	0af68063          	beq	a3,a5,612 <vprintf+0x192>
      } else if(c0 == 'l' && c1 == 'x'){
 576:	07800793          	li	a5,120
 57a:	0ef68263          	beq	a3,a5,65e <vprintf+0x1de>
        putc(fd, '%');
 ...
 5a2:	e43ff0ef          	jal	3e4 <printint>
        i += 1;
 5a6:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
 5a8:	8bca                	mv	s7,s2
      state = 0;
 5aa:	4981                	li	s3,0
        i += 1;
 5ac:	b705                	j	4cc <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 5ae:	06400793          	li	a5,100
 5b2:	02f60763          	beq	a2,a5,5e0 <vprintf+0x160>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 5b6:	07500793          	li	a5,117
 5ba:	06f60963          	beq	a2,a5,62c <vprintf+0x1ac>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 5be:	07800793          	li	a5,120
 5c2:	faf61ee3          	bne	a2,a5,57e <vprintf+0xfe>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 684:	855a                	mv	a0,s6
 686:	d41ff0ef          	jal	3c6 <putc>
  putc(fd, 'x');
 68a:	07800593          	li	a1,120
 68e:	855a                	mv	a0,s6
 690:	d37ff0ef          	jal	3c6 <putc>
 694:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 696:	00000b97          	auipc	s7,0x0
 69a:	272b8b93          	add	s7,s7,626 # 908 <digits>
 69e:	03c9d793          	srl	a5,s3,0x3c
 6a2:	97de                	add	a5,a5,s7
 6a4:	0007c583          	lbu	a1,0(a5)
 6a8:	855a                	mv	a0,s6
 6aa:	d1dff0ef          	jal	3c6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6ae:	0992                	sll	s3,s3,0x4
 6b0:	397d                	addw	s2,s2,-1
 6b2:	fe0916e3          	bnez	s2,69e <vprintf+0x21e>
        printptr(fd, va_arg(ap, uint64));
 6b6:	8bea                	mv	s7,s10
      state = 0;
 6b8:	4981                	li	s3,0
 6ba:	bd09                	j	4cc <vprintf+0x4c>
        putc(fd, va_arg(ap, uint32));
 ...
 6ca:	8bca                	mv	s7,s2
      state = 0;
 6cc:	4981                	li	s3,0
 6ce:	bbfd                	j	4cc <vprintf+0x4c>
        if((s = va_arg(ap, char*)) == 0)
 6d0:	008b8993          	add	s3,s7,8
 ...
 6f0:	8bce                	mv	s7,s3
      state = 0;
 6f2:	4981                	li	s3,0
 6f4:	bbe1                	j	4cc <vprintf+0x4c>
          s = "(null)";
 6f6:	00000917          	auipc	s2,0x0
 6fa:	20a90913          	add	s2,s2,522 # 900 <malloc+0xfc>
        for(; *s; s++)
...
free(void *ap)
{
 782:	1141                	add	sp,sp,-16
 784:	e422                	sd	s0,8(sp)
 786:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 788:	ff050693          	add	a3,a0,-16
 ...
 7b8:	00e6ea63          	bltu	a3,a4,7cc <free+0x4a>
{
 ...
 7d0:	6390                	ld	a2,0(a5)
 7d2:	02059813          	sll	a6,a1,0x20
 7d6:	01c85713          	srl	a4,a6,0x1c
 ...
 7e0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 7e4:	4790                	lw	a2,8(a5)
 7e6:	02061593          	sll	a1,a2,0x20
 7ea:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 854:	7b090913          	add	s2,s2,1968 # 1000 <freep>
  if(p == SBRK_ERROR)
 858:	5afd                	li	s5,-1
 85a:	a885                	j	8ca <malloc+0xc6>
    base.s.ptr = freep = prevp = &base;
 85c:	00000797          	auipc	a5,0x0
 860:	7b478793          	add	a5,a5,1972 # 1010 <base>
