...
forktest(void)
{
  ...
  36:	3fe50513          	add	a0,a0,1022 # 430 <getpinfo+0xe>
  ...
  58:	3ec50513          	add	a0,a0,1004 # 440 <getpinfo+0x1e>
  ...
  94:	40050513          	add	a0,a0,1024 # 490 <getpinfo+0x6e>
  ...
  ac:	3b850513          	add	a0,a0,952 # 460 <getpinfo+0x3e>
  b0:	f51ff0ef          	jal	0 <print>
      exit(1);
  b4:	4505                	li	a0,1
  b6:	2bc000ef          	jal	372 <exit>
    print("wait got too many\n");
  ba:	00000517          	auipc	a0,0x0
  be:	3be50513          	add	a0,a0,958 # 478 <getpinfo+0x56>
...
memset(void *dst, int c, uint n)
{
 ...
 168:	87aa                	mv	a5,a0
 16a:	1602                	sll	a2,a2,0x20
 16c:	9201                	srl	a2,a2,0x20
...
atoi(const char *s)
{
 ...
 26a:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 26c:	0705                	add	a4,a4,1
 26e:	0025179b          	sllw	a5,a0,0x2
 272:	9fa9                	addw	a5,a5,a0
 274:	0017979b          	sllw	a5,a5,0x1
 278:	9fb5                	addw	a5,a5,a3
 27a:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 27e:	00074683          	lbu	a3,0(a4)
 282:	fd06879b          	addw	a5,a3,-48
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2a6:	1602                	sll	a2,a2,0x20
 2a8:	9201                	srl	a2,a2,0x20
 ...
 2d0:	fff6079b          	addw	a5,a2,-1
 2d4:	1782                	sll	a5,a5,0x20
 2d6:	9381                	srl	a5,a5,0x20
 2d8:	fff7c793          	not	a5,a5
 2dc:	97ba                	add	a5,a5,a4
      *--dst = *--src;
 2de:	15fd                	add	a1,a1,-1
 2e0:	177d                	add	a4,a4,-1
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 2f8:	fff6069b          	addw	a3,a2,-1
 2fc:	1682                	sll	a3,a3,0x20
 2fe:	9281                	srl	a3,a3,0x20
 300:	0685                	add	a3,a3,1
